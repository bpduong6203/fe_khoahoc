                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-1">
                        <div className="space-y-3 mb-6">
                            <div
                                className={`border rounded-lg overflow-hidden transition-all duration-300 ${paymentMethod === "card" ? "shadow-md" : ""
                                    }`}
                            >
                                <div
                                    className="p-3 flex items-center justify-between bg-white cursor-pointer"
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-300 ${paymentMethod === "card" ? "max-h-80 p-3" : "max-h-0"
                                        }`}
                                >
                                    <div className="space-y-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full p-2 border rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-200"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-xs text-gray-600 mb-1">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full p-2 pl-10 border rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-200"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex">
                                                <input
                                                    ...
                                                    className="flex-1 p-2 border rounded-l-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-200"
                                                />
                                                <button className="bg-white border border-l-0 rounded-r-md px-4 text-purple-600 font-medium text-sm">
                                                    Áp dụng
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div
                                className={`border rounded-lg overflow-hidden transition-all duration-300 ${paymentMethod === "gpay" ? "shadow-md" : ""
                                    }`}
                            >
                                <div
                                    className="p-3 flex items-center justify-between bg-white cursor-pointer"
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-300 ${paymentMethod === "gpay" ? "max-h-20 p-3" : "max-h-0"
                                        }`}
                                >
                            ...
                            <div
                                className={`border rounded-lg overflow-hidden transition-all duration-300 ${paymentMethod === "paypal" ? "shadow-md" : ""
                                    }`}
                            >
                                <div
                                    className="p-3 flex items-center bg-white cursor-pointer"
                    ...
                    <div className="w-full lg:w-80">
                        <div className="bg-gray-100 p-4 rounded-lg shadow-sm bg-gradient-to-br from-gray-100 to-purple-50">
                            <div className="mb-4">
