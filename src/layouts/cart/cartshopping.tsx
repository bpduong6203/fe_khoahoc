        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="flex items-center border rounded-lg overflow-hidden mb-4 shadow-sm hover:shadow-md transition-shadow"
                style={{
                  padding: "0.75rem",
                  borderWidth: "1px",
                  borderColor: "#e5e7eb",
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <button
                className="w-full bg-purple-600 text-white py-2 rounded-lg mb-4 hover:bg-purple-700 transition-colors"
